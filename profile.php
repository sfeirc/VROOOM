...
<body class="min-h-screen">
    ...
    <script>
        ...
        document.getElementById('profile-form').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    updateNavigation(); // Mettre à jour la navigation avec les nouvelles infos
                } else {
                ...
                if (file) {
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            loadUserData();
                            updateNavigation(); // Mettre à jour la navigation avec la nouvelle photo
                        } else {
        ...
        // Ajouter l'événement pour le bouton de déconnexion en bas de page
        document.getElementById('logout-btn-bottom').addEventListener('click', function(e) {
            e.preventDefault();
            logout(); // Utilise la fonction de déconnexion de auth-check.js
        });
